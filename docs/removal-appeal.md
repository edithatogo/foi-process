...
This repository publishes reviewed synthetic fixtures. A future public export must retain this
workflow and add the named operator contact before production data is enabled.
...
security exposure is treated as urgent: pause the affected publication, preserve revision and
