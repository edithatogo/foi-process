...
## 2026-06-23 — Track 18 phase 4 completion

Automation and retrospective controls.
...
- `next_check_to_add`:
  - Add a reusable pre-commit/CI check that validates `learning-log.md` entries against
    `conductor/templates/learning-entry.schema.json`.
